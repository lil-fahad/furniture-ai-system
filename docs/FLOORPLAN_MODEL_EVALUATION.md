...
The repository describes 4,976 floor-plan images with polygon annotations including rooms, walls, doors and windows. The derivative dataset and the upstream CubiCasa5K terms must both be reviewed before production/commercial training. Dataset metadata alone is not sufficient authorization.
